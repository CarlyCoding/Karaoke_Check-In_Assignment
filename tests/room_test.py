...
# Extensions- need to test for max capacity of a room
    def test_is_room_full(self):
        guest = Guest("Snake", 600)
        self.room3.check_in_guest(guest)
        self.assertEqual(1, len(self.room3.guests))
        self.assertEqual(True, self.room3.is_room_full())

# Will check inverse of the scenario
    def test_is_room_empty(self):
        self.assertEqual(False, self.room4.is_room_full())

# Set an entry fee and check if customer can pay- setting in Guest 
